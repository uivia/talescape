...
const Archive = () => {
  ...
  const handleRemoveBook = (bookId) => {
    const updatedBooks = archivedBooks.filter(book => book.id !== bookId);
    setArchivedBooks(updatedBooks);
    localStorage.setItem('archivedBooks', JSON.stringify(updatedBooks));
  };
